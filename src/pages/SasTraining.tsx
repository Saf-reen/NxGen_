        ...
        <div className="min-h-screen font-sans">
            ...
            <div className="bg-primary text-white py-16">
                <div className="container mx-auto px-4">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">SAS Training in Pune Maharashtra</h1>
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="lg:w-1/3 space-y-8">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 sticky top-24">
                            <h3 className="text-xl font-bold mb-4 text-center text-primary">Enquire for SAS Course</h3>
                            <form className="space-y-4">
                                <input type="text" placeholder="Name" className="w-full px-4 py-2 border rounded focus:outline-none focus:border-secondary" />
                                <input type="email" placeholder="Email" className="w-full px-4 py-2 border rounded focus:outline-none focus:border-secondary" />
                                <input type="tel" placeholder="Phone" className="w-full px-4 py-2 border rounded focus:outline-none focus:border-secondary" />
                                <textarea placeholder="Message" rows={3} className="w-full px-4 py-2 border rounded focus:outline-none focus:border-secondary"></textarea>
