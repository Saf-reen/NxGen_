...
const InstructorLogin = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axiosInstance.post("/api/auth/instructor-login/", {
            ...
            toast.success("Login successful! Welcome to the Instructor Portal.");
            ...
            <div className="container mx-auto px-4 flex justify-center">
                <Card className="w-full max-w-md shadow-lg border-t-4 border-t-blue-600">
                    <CardHeader className="space-y-1">
                        <CardTitle className="text-2xl font-bold text-center text-[#000080]">Instructor Portal</CardTitle>
